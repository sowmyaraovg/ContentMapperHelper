...
class Section(db.Model):
    '''Section table with id as Primary key and set a relationship to SectionContent'''
...
class SectionContent(db.Model):
    '''SectionContent Table with id as Primary key and set a relationship with Docs & Gaps Table'''
...
class Docs(db.Model):
    '''Docs Table with id as Primary key and set a relationship with SectionContent Table'''
...
class Gaps(db.Model):
    '''Gaps Table with id as Primary key and set a relationship with SectionContent Table'''
